package com.luyao.vehicle.utils;
...
public class Hex {
    ...
    {
        byte[] middle = ByteBuffer.allocate(4).putFloat(value).array();
    ...
    {
        byte[] middle = ByteBuffer.allocate(8).putDouble(value).array();
    ...
    public static byte[] fromUnsignedInt(long value)
    {
        ...
        byte[] middle =  Arrays.copyOfRange(bytes, 4, 8);
     ...
     * @return String 每个Byte之间空格分隔，如: [61 6C 6B]
     */
    public static String[] str2HexStrArray(String str) {
